...
$assignments = [
    ...
    'Umi' => [
        'resources/views/admin', // exclude artworks, orders, dashboard, tickets, payment
        'database/factories',
        'database/schema'
    ],
    'Finsus' => [
    ...
    'Ghibran' => [
        'resources/views/ordinary', // exclude art, plan-your-visit
...
foreach ($assignments as $person => $dirs) {
    ...
    foreach ($dirs as $dir) {
        ...
        if ($person === 'Umi' && $dir === 'resources/views/admin') {
            ...
            $exclude[] = 'resources/views/admin/dashboard';
            $exclude[] = 'resources/views/admin/tickets';
            $exclude[] = 'resources/views/admin/payment'; // strictly payment, not payments
        }
